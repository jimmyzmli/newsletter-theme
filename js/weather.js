...
function getWeather() {
	...
	return setConditions(loc_conditions, loc_conditions_img, loc_temp, loc_humidity);
    } else {
	...
	$.getJSON(url, function(data) {
	    ...
	    return setConditions(conditions, conditions_img, temp, humidity);
	});
    }
}
...
function setConditions(conditions, conditions_img, temp, humidity) {
    ...
    r.temp = temp;
    r.humidity = humidity;
    r.country = $.cookie("loc_country");
    r.region = $.cookie("loc_region");
    r.city = $.cookie("loc_city");    
    return r;
}
